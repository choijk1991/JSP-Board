...
<core:set var="originalLine" value='----- ORIGINAL CONTENT -----'/>
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8">
...
<body>
	...
	<form name="articleForm" method="post" action="${contextPath}/board/insert.do?parentNo=${article.number}" enctype="multipart/form-data">
		<table border="0" align="center">
			<tr>
				<td align="right">SUBJECT</td>
				<td colspan="2"><input type="text" size="67" maxlength="500" name="txtTitle" value="[RE] ${article.title}"/></td>
			</tr>
			<tr>
				<td align="right" valign="top">CONTENT</td>
				<td colspan="2">
					<textarea name="txtContent" rows="10" cols="65" maxlength="4000">
${originalLine}
